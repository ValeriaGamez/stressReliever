...
<path d="M169.924 92.7365C172.893 86.7704 181.92 89.3657 181.267 95.9974L177.699 132.226C177.331 135.956 173.672 138.44 170.07 137.404L157.422 133.768C153.82 132.733 152.039 128.685 153.708 125.329L169.924 92.7365Z" fill="`+ color +`"/>
<ellipse cx="94.0439" cy="207.108" rx="34.5" ry="22" fill="`+ color +`"/>
<rect x="43.5439" y="154.108" width="98" height="70" rx="35" fill="`+ color +`"/>
<rect x="71.5439" y="164.372" width="112.443" height="75.4635" rx="37.7317" transform="rotate(-27.8162 71.5439 164.372)" fill="`+ color +`"/>
<rect x="43.5439" y="174.108" width="37" height="88" rx="18.5" fill="`+ color +`"/>
<rect x="110" y="174.108" width="37" height="88" rx="18.5" fill="`+ color +`"/>
<rect x="155.544" y="149.108" width="37" height="81" rx="18.5" fill="`+ color +`"/>
</svg>
`
...
function setPet(myPet, myBreed) {
    ...
    addAnimation("@keyframes normal {\
        0% {\
            background: url(\"data:image/svg+xml,"+ encodeSvg(svg) + "\");\
